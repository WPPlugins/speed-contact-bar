		...
		$this->form_structure = array(
			'1st_section' => array(
				...
				'options' => array(
					...
					'phone_text' => array(
						'type'    => 'textfield',
						'title'   => __( 'Phone Text', $this->plugin_slug ),
						'desc'    => __( 'Enter a text for the phone link, otherwise the phone number will be displayed.', $this->plugin_slug ),
					),
					'cellphone' => array(
						'type'    => 'textfield',
					...
					'cellphone_text' => array(
						'type'    => 'textfield',
						'title'   => __( 'Cell Phone Text', $this->plugin_slug ),
						'desc'    => __( 'Enter a text for the cell phone link, otherwise the cell phone number will be displayed.', $this->plugin_slug ),
					),
					'facebook' => array(
						'type'    => 'url',
